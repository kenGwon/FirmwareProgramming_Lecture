...
extern volatile int TIM10_10ms_fan_lcd_display_clear;
...
uint8_t dcmotor_start_stop_flag = 0; // dcmotor start/stop indicator [플래그 변수]
uint8_t dcmotor_forward_backward_flag = 0; // 정방향 0, 역방향 1 [플래그 변수]
...
int auto_mode_remain_time = 30; // auto mode 남은시간
